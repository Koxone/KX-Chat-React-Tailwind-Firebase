    ...
    <div onClick={handleClick} className="group relative overflow-hidden">
      ...
      >
        ...
        <div className="relative flex-shrink-0">
          <div
            className="absolute inset-0 bg-gradient-to-br from-emerald-400/20 to-teal-500/20 rounded-full blur-md opacity-0 group-hover:opacity-100 
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between">
            ...
            <div className="flex flex-col items-end gap-2 ml-4 flex-shrink-0">
              <p
                className="text-emerald-400 text-xs font-medium tracking-wider uppercase group-hover:text-emerald-300 group-active:text-emerald-300 
              transition-colors duration-300"
              >
                12:30 PM
              </p>
              <div className="relative">
                ...
                {unreadCount > 0 && (
                  <div className="relative">
                    <div className="absolute inset-0 bg-emerald-400 rounded-full blur-sm opacity-50 scale-110"></div>
                    <div
                      className="relative flex items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-emerald-500 
    min-w-[20px] h-[20px] px-1.5 shadow-lg group-hover:scale-110 group-active:scale-110 transition-transform duration-300"
                    >
        ...
        <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-transparent via-emerald-400/50 to-transparent opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300"></div>

        {/* Hover overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
      </div>
    </div>
  );
}
