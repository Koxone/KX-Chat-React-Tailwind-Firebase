...
function ChatCard() {
  return (
    <div className="group relative overflow-hidden">
      ...
      <div className="flex items-center gap-4 px-4 py-3 w-full cursor-pointer transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:from-neutral-800/40 hover:to-neutral-700/20 active:bg-gradient-to-r active:from-neutral-800/40 active:to-neutral-700/20 border-b border-neutral-800/60 group-hover:border-neutral-700/80 group-active:border-neutral-700/80">
        
        {/* Avatar with glow effect */}
        <div className="relative flex-shrink-0">
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-400/20 to-teal-500/20 rounded-full blur-md opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300"></div>
          <img 
